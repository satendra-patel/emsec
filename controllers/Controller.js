...
const Todo = require('../models/mytodos');
...
exports.createTask = asyncHandler(async (req, res) => {
    ...
    const todo = await Todo.create({task, is_completed,end_date});
    res.status(201).json({
        success: true,
        data: todo,
 ...
 */
 exports.updateTask = asyncHandler(async (req, res) => {
    ...
    if(existTask){
        existTask.task = task;
        existTask.is_completed = is_completed
        existTask.end_date = end_date
